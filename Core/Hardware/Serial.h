...
typedef struct{
	...
	int16_t  raw_current;                //电流原始�?
	int16_t  current;                    //真实电流 = 电流原始�? - 30000
	uint16_t soc_raw;                    //当前电量原始�?
	float    soc;                        //当前电量�?
...
extern EP_DataTypeDef bat_12v;              /* 12V 电池（RS485�?*/
extern EP_DataTypeDef bat_28v;              /* 28V 电池（RS485�?*/
